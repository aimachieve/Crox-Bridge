    ...
    <>
      {!isMd && !isSm && !isXs && !isLg ? (
        <StyledMenu className="menu">
          <img src="/logo-main.png" width="65px" alt="logo1" style={{ margin: "20px 59px", marginRight: "23.41px", height: "23.64px" }} />
          <StyledButton className="button"><a href="/">Home</a></StyledButton>
              ...
              <StyledDropDownItem className="menu-item swap">
                <a style={{ marginTop: '3px', marginLeft: '7px' }} href="https://exchange.croxswap.com/#/swap">
                  ...
                  <Flex flexDirection='column' ml='20px'>
                    ...
                    <Text style={{ lineHeight: '24px' }}>Delta DEX</Text>
                  </Flex>
                </a>
              </StyledDropDownItem>
              <StyledDropDownItem className="menu-item liquidity">
                <a style={{ marginTop: '3px', marginLeft: '7px' }} href="/">
                  <Flex alignItems='center'>
          ...
          <StyledButton className="button"><a href="#">Farms</a></StyledButton>
          <StyledButton className="button"><a href="#">Pools</a></StyledButton>
              ...
              <StyledDropDownItem className="menu-item swap">
                <a style={{ marginTop: '3px', marginLeft: '7px' }} href="https://bridge.croxswap.com">
                  <Flex alignItems='center'>
                    ...
                    <Text color="white" bold ml='5px' fontSize="14px">DELTA Bridge (soon)</Text>
                  </Flex>
                  <Flex flexDirection='column' ml='20px'>
                    <Text color="white" style={{ lineHeight: '24px' }} fontSize='14px' mt="10px">Exchange your tokens using DELTA</Text>
                  </Flex>
                </a>
              </StyledDropDownItem>
              <StyledDropDownItem className="menu-item swap">
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            <Link href='https://coinmarketcap.com/currencies/croxswap' external style={{ textDecoration: 'none' }}>
              <CroxPriceSection>
                <Text fontSize='14px' color="white">$Delta: </Text>
